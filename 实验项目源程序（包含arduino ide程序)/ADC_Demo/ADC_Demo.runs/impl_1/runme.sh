...
HD_PWD='C:/Xilinx/ADC-Interface/ADC_Demo/ADC_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ADC_Demo.tcl -notrace
