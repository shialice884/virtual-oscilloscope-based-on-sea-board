...
HD_PWD='C:/Xilinx/ADC-Interface/ADC_Demo/ADC_Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_Demo.tcl
